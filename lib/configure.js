...
module.exports = function defaultConfig (userConfig) {
  ...
  var config = {
    environment: {
      ...
      sessionSecret: 'ch4n9e_m#_b4_d3pl0yin9_7o_pr0duct1oN!', // Ideally this should be a cryptographic hash
      sessionLifetime: 604800, // 7-day session
      unsafeLoginSecret: '(h4n9e-m#-b4-d3ploy1n9-7o-pr0duct10N!' // Also should be a hash
    },
    ...
    db: {
      ...
      connstring: process.env.DBCONNSTRING || 'http://localhost:5984/test-db'
    },
    ...
    mandrill: {
      ...
      fromName: process.env.MANDRILL_FROM_EMAIL || 'The Localhost Team'
    },
  ...
  if (typeof userConfig === 'string') {
    ...
    if (userConfig.longStackTraces !== false) {
