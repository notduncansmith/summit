...
Database.prototype.get = function (name) {
  ...
  .catch(function (err) {
    console.log('ONOEZ: Failed to `get` document with _id: ', name, 'Reason: ', err.message);
    return {};
  });
};
...
Database.prototype.put = function (name, doc, force) {
  ...
  .catch(function (err) {
    console.log('ONOEZ: Failed to `put` with args: ', arguments);
    console.log(err);
  });
};
...
Database.prototype.view = function (designDocName, viewName, params) {
  ...
  .catch(function (err) {
    console.log('ONOEZ: Failed to call design method: ', designDocName + '/' + viewName + '\nwith params ', params, '\nReason: ', err.message);
  });
};
